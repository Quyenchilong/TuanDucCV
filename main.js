...
/*===== Work Popup =====*/
// Mở popup khi click vào nút Demo
...
// Hiển thị chi tiết dự án trong popup
function portfolioItemDetails(portfolioItem) {
    const img = portfolioItem.querySelector(".work__img").src;
    ...
    document.querySelector(".pp__thumbnail img").src = img;
